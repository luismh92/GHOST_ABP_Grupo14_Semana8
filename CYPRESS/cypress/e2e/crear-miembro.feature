...
Feature: crear miembro sitio
    ...
    Scenario: Crear miembro del sitio con un nombre invalido mas de los caracteres permitidos
        Given Un usuario se encuentra en la pagina de inicio e inicia sesion en Ghost
        When el usuario se dirige a la seccion members del sitio
        And el usuario da clic en el boton New Member
    ...
    Scenario: Crear miembro del sitio con un mail invalido mas de los caracteres permitidos
        Given Un usuario se encuentra en la pagina de inicio e inicia sesion en Ghost
        When el usuario se dirige a la seccion members del sitio
        And el usuario da clic en el boton New Member
    ...
    Scenario: Crear miembro del sitio con un email
        Given Un usuario se encuentra en la pagina de inicio e inicia sesion en Ghost
        When el usuario se dirige a la seccion members del sitio
        And el usuario da clic en el boton New Member
        And el usario digita mail
