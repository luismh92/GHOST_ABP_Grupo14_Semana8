...
Feature: Funcionalidad de crear un post
   ...
   @CrearPost
    ...
    Scenario: El usuario crea un post con el icono de nuevo post (titulo, url invalid)
        Given Un usuario se encuentra en la pagina principal del admin de Ghost
        When el usuario hace click sobre el icono post
        And el usuario hace click sobre el boton Settings
    ...
    Scenario: El usuario crea un post con el icono de nuevo post (titulo, hora invalid)
        Given Un usuario se encuentra en la pagina principal del admin de Ghost
        When el usuario hace click sobre el icono post
        And el usuario hace click sobre el boton Settings
    ...
    Scenario: El usuario crea un post con el icono de nuevo post (titulo, contenido, hora invalid)
        Given Un usuario se encuentra en la pagina principal del admin de Ghost
        When el usuario hace click sobre el icono post
        And el usuario hace click sobre el boton Settings
        And el usuario agrega un numero a la hora
    ...
    Scenario: El usuario crea un post con el icono de nuevo post (contenido, hora invalid)
        Given Un usuario se encuentra en la pagina principal del admin de Ghost
        When el usuario hace click sobre el icono post
        And el usuario hace click sobre el boton Settings
        And el usuario agrega un numero a la hora
    ...
    Scenario: El usuario crea un post con el icono de nuevo post (titulo, url, hora invalid)
        Given Un usuario se encuentra en la pagina principal del admin de Ghost
        When el usuario hace click sobre el icono post
        And el usuario hace click sobre el boton Settings
        And el usuario escribe en los campos Url mas de los caracteres
    ...
    Scenario: El usuario crea un post con el icono de nuevo post (contenido, url, hora invalid)
        Given Un usuario se encuentra en la pagina principal del admin de Ghost
        When el usuario hace click sobre el icono post
        And el usuario hace click sobre el boton Settings
        And el usuario escribe en los campos Url mas de los caracteres
