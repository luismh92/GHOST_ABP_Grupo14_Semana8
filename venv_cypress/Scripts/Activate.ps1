...
$env:NODE_VIRTUAL_ENV="C:\Users\DELL\Documents\COURSERA\MISO\Repositories\GHOST_ABP_Grupo14\venv_cypress"
...
function global:prompt {
    Write-Host -NoNewline -ForegroundColor Green '(venv_cypress) '
    _OLD_VIRTUAL_PROMPT
}
